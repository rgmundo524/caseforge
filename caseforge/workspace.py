...
from .case_scaffold import bootstrap_evidence_root_from_local_template
...
def _bootstrap_web_runtime_from_local_template(*, workspace_root: Path, output_root: Path) -> None:
    bootstrap_evidence_root_from_local_template(case_root=output_root, cases_home=workspace_root.parent)
...
def build_web_draft(*, workspace_root: Path, output_name: str) -> tuple[Path, Path]:
    ...
    _bootstrap_web_runtime_from_local_template(workspace_root=workspace_root, output_root=output_root)
